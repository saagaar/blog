      ...
      <div class="" v-if="status===false">
        ...
        <form method="POST">
          <div class="input-wrapper position-relative">
            <input type="email"  class="newsletter-form" id="newsletter" placeholder="Enter your email" @blur="$v.form.email.$touch()" v-model.trim="form.email">
            ...
            <button type="submit" @click.prevent="submitForm()" class="btn newsletter-btn">subscribe</button>
          </div>
        </form>
      </div>
</template>
...
export default {
        ...
        methods:{
            ...
            {
              curObject.form.post('/newsletter/subscribe').then(response => {
