...
<template>
<div>
<!--    <Bullet-List-loader v-if="!initialState.featuredBlog"></Bullet-List-loader>
 --><section class="fullwidth-block area-padding-bottom" v-if="initialState.featuredBlog" >
    ...
    <div class="three-block  area-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="area-heading">
                        <h3>Featured latest Collections  <span> <a href="#" class="b_all genric-btn link-border circle">See All Collections <i class="fa fa-angle-double-right"></i></a> </span></h3>
                    </div>
                </div>
            </div>
            <div class="row">
