               ...
               <div class="form-group">
                  <label for="status">Status</label>
                    <div class="custom-control custom-radio radio-inline">
                        <input type="radio" class="custom-control-input flat-red" name="status" value="Y" @if($subscription->status=='Y') checked @endif>
                        <label class="custom-control-label" for="defaultChecked">Subscribed</label>
                    </div>
                    <div class="custom-control custom-radio radio-inline">
                        <input type="radio" class="custom-control-input flat-red" name="status" value="N"  @if($subscription->status=='N') checked @endif >
