            ...
            <div class="box-body">
             ...
             <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>{{$member->title}}</td>
                   <td>{{$member->url }}</td>
                   <td><img src="{{asset('uploads/client-images/'.$member->logo) }}" alt="Client Image" height="42" width="42"></td>
                  <td>
                  ...
                  <td><a onClick="return ConfirmDelete();" href="{{route('client.delete', $member->id)}}"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                </tr> 
                @endforeach
                @else
                    <tr>
