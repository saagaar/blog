            ...
            <form action="{{route('services.edit',$service->id)}}" method="POST" enctype="multipart/form-data"> 
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <img src='/uploads/services-images/{{$service->icon}}' width="50"/>
                 ...
                 <div class="form-group">
                  <label for="status">Status</label>
                    ...
                    <div class="custom-control custom-radio radio-inline">
                        <input type="radio" class="custom-control-input flat-red" name="status"  value="2" @if($service->status=='2') checked @endif>
