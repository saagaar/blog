             ...
             <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    @else
                   <span class="label label-warning ">iPay88 </span>
                  @endif
                  </td>
                  <td><img src="{{asset('images/paymentgateway-images/'.$data->image) }}" alt="paymentgateway Image" height="42" width="42"></td>   
                   <td>
                      ...
                      <td>  
                        <input data-id="{{$data->id}}" data-url="{{route('paymentgateway.changemode')}}" style="font-size:5px;padding:0px;" data-width="80" data-height="25" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="warning" data-toggle="toggle" data-on="Live" data-off="Test"{{$data->mode ? 'checked' : ''}}>
                      </td>         
