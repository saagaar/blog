             ...
             <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>{{$member->title}}</td>
                   ...
                   <td><img src="{{asset('frontend/images/services-icon/'.$member->icon) }}" alt="services Image" height="42" width="42"></td> 
                  <td>
                    <input data-id="{{$member->id}}" data-url="{{route('services.changestatus')}}" style="size: 12px;"  data-width="80" data-height="25" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="Inactive"{{$member->status ? 'checked' : '' }}>
                  </td>              
