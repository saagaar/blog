            ...
            <form action="{{route('testimonial.edit',$testimony->id)}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <img src='/uploads/testimonial-images/{{$testimony->image}}' width="50"/>
                ...
                <div class="form-group">
                  <label for="status">Status</label>
                    ...
                    <div class="custom-control custom-radio radio-inline">
                        <input type="radio" class="custom-control-input flat-red" name="status"  value="2" @if($testimony->status=='2') checked @endif>
