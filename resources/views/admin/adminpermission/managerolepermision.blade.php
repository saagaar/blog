                                  ...
                                  @forelse ($eachmodule as $key=>$eachmoduleitems)
                                   ...
                                   ?>
                                     <div class="form-group ">
                                        <!-- <label> -->
                                       <p class="text-light-blue" style="border-bottom: 1px solid #d2d6de;margin-bottom: 10px;padding-bottom: 5px;font-weight: 600;color: #857d89 !important">   <input name="permission_id[]" type="checkbox" class="minimal" {{ $checked }} value="{{$eachmoduleitems['id']}}"> &nbsp;
