...
Route::prefix('admin')->group(function()
{
	...
	**/
	...
	Route::match(['get','post'],'Admin\create/blog','BlogController@create')->name('blog.create');
	Route::match(['get','post'],'Admin\edit/blog/{id}/{slug}','BlogController@edit')->name('blog.edit');
